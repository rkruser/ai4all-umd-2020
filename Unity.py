...
to_tensor= transforms.ToTensor()
im_flower_tensor = to_tensor(grayscale(im_flower))
...
#vertical_kernel = torch.Tensor([[-1, 0, 1],
                               # [-2, 0, 2],
                         #       [-1, 0, 1]])
#im_flower_vertical_tensor = apply_convolution(im_flower_tensor, vertical_kernel)
#im_flower_vertical_tensor = rescale(im_flower_vertical_tensor, perc1=20, perc2=98)
...
#horizontal_kernel = torch.Tensor([[1, 2, 1],
                                #  [0, 0, 0],
                                #  [-1, -2, -1]])
#im_flower_horizontal_tensor = apply_convolution(im_flower_tensor, horizontal_kernel)
#im_flower_horizontal_tensor = rescale(im_flower_horizontal_tensor, perc1=20, perc2=98)
#display(to_pil(im_flower_horizontal_tensor))

#blur_kernel = torch.ones(10,10)
#im_flower_blur = apply_convolution(im_flower_tensor, blur_kernel)
#im_flower_blur = rescale(im_flower_blur, perc1=0, perc2=100)
#display(to_pil(im_flower_blur))
